---
name: capture-issue
description: 検討中の論点・調査結果・その場の方針を GitHub Issue に記録する。まだ決まっていないことを書き留めるとき、人間に意思決定を仰ぐ論点を整理するとき、また決着した Issue を ADR 化して閉じるときに使う。リポジトリ内に暫定メモのファイルを作ってはいけない。
---

# 論点を Issue に残す・閉じる

その場の方針・検討メモ・調査ログは **GitHub Issue** に置く
（[ADR-0009](../../../docs/adr/0009-notes-as-github-issues.md)）。
**リポジトリ内に暫定メモのファイルを作らない。** `docs/notes/` は廃止済み。
